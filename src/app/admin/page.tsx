...
export default function AdminPage() {
  ...
  return (
    <div className="mx-auto max-w-5xl px-5 pb-28 pt-28 md:px-8 md:pt-36">
      ...
      {/* Refresh OTA calendars — a page-level action above the tabs, accessible
          from any view (only shown when OTA feeds are connected). */}
      {data?.icalConfigured && (
      ...
      {/* View toggle */}
      <div className={`flex gap-2 border-b border-paper/10 ${data?.icalConfigured ? "mt-8" : "mt-12"}`}>
